...
DROP TABLE JOB_METADATA IF EXISTS;
...
(
    ...
    LAST_SUCCESSFUL_RUN_TIME DATETIME(6)  NOT NULL,
    VERSION                  BIGINT       NOT NULL DEFAULT 0,
    CREATED_AT               DATETIME(6)  NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    UPDATED_AT               DATETIME(6)  NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)
);

INSERT INTO JOB_METADATA (JOB_NAME, LAST_SUCCESSFUL_RUN_TIME, VERSION)
VALUES ('postDbToEsMigrationJob', '1970-01-01 00:00:00', 0);
